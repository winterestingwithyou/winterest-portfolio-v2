...
| **DUP-04** | Form / Utility | `slugify()` | `src/features/technologies/category-editor-form.tsx`<br>`src/features/technologies/technology-editor-form.tsx` | ⏳ Pending | Pindahkan ke `src/lib/utils.ts` |
| **DUP-05** | Database Check | `isMissingTableError()` | `src/features/dashboard/loaders.ts`<br>`src/features/projects/public-loaders.ts` | ⏳ Pending | Pindahkan ke `src/lib/db-utils.ts` / `src/db/index.ts` |
| **DUP-06** | Formatting | `formatDate()` | `src/routes/dashboard/media.tsx`<br>`src/routes/projects/$slug.tsx` | ⏳ Pending | Satukan helper format tanggal di `src/lib/utils.ts` |
