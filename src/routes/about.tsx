      ...
      <Container>
        <section className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          <div>
            ...
            <h1 className="max-w-3xl text-4xl font-semibold leading-tight tracking-tight text-(--brand-ink) sm:text-5xl">
              {copy.about.title}
            </h1>
          </div>
        ...
        <section className="mt-16">
          ...
          <div className="grid gap-4">
            {timeline.map((item) => (
              ...
              >
                <p className="m-0 text-sm font-bold text-(--brand-orange-deep)">
                  {item.period}
                </p>
                <div>
