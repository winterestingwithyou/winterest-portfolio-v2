        ...
        <FieldGroup>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <form.Field
              ...
              children={(field) => (
                <Field>
                  <FieldLabel htmlFor={field.name}>Tanggal Selesai</FieldLabel>
                  <Input
                    type="date"
                    id={field.name}
                    name={field.name}
            ...
            <form.Field
              ...
              children={(field) => (
                <Field>
                  <FieldLabel htmlFor={field.name}>Tanggal Publish</FieldLabel>
                  <Input
                    type="date"
                    id={field.name}
                    name={field.name}
              ...
              <div className="rounded-xl border border-(--brand-line) bg-(--surface-strong) p-4">
                ...
                >
                  <FieldContent>
                    ...
                    <FieldDescription>
                      Tampilkan di deretan project unggulan (Featured Projects)
                      pada homepage.
                    </FieldDescription>
                  </FieldContent>
                  <Checkbox
          ...
          <form.Field
            ...
            children={(field) => (
              <Field>
                <FieldLabel>Teknologi Terkait</FieldLabel>
                {availableTechnologies.length === 0 ? (
                  <p className="text-xs text-(--brand-muted)">
                    Belum ada data teknologi di Stack Management.
                  </p>
                ) : (
