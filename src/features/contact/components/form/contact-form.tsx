              ...
              children={([canSubmit, turnstileToken]) => {
                ...
                return (
                  <Button
                    type="submit"
                    disabled={!isReady}
                    className="inline-flex min-h-10.5 w-full items-center justify-center gap-2 rounded-full bg-(--brand-orange) px-5 text-sm font-bold text-white transition hover:-translate-y-px hover:bg-(--brand-orange-deep) disabled:cursor-not-allowed disabled:opacity-60 disabled:hover:translate-y-0 sm:min-h-11.5"
                  >
                    {isPending ? (
                      <>
                        <Loader2
