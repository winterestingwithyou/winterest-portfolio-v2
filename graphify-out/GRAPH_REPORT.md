...
## Corpus Check
- 124 files · ~199,081 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2568 nodes · 3216 edges · 240 communities (53 shown, 187 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 24 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `30f8deeb`
...
Cohesion: 0.05
Nodes (48): Route, Route, Route, Route, Route, Route, Route, Route (+40 more)
...
Cohesion: 0.16
Nodes (12): DashboardShell(), DashboardShellProps, dashboardCopy, getDashboardCopy(), DashboardHome(), Route, DashboardMedia(), DashboardProjectEdit() (+4 more)
...
Cohesion: 0.06
Nodes (51): Footer(), Header(), Container(), ContainerProps, SectionHeader(), SectionHeaderProps, ProjectCard(), ProjectCardProps (+43 more)
...
## Knowledge Gaps
- **1221 isolated node(s):** `$schema`, `style`, `rsc`, `tsx`, `config` (+1216 more)
